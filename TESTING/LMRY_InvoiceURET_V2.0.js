...
//#endregion Librerías e Instancias

//autopercAfterSubmit //autoperc_beforeSubmit
...
//#endregion Definición de variables globales
    ...
    function beforeLoad(scriptContext) {
      try {
        ...
        //#region Variables lobales en beforeLoad
        ...
        //#endregion Variables lobales en beforeLoad

        //#region Oculta campos por Fields Hide
        ...
        //#endregion Oculta campos por Fields Hide

        //#region Obtiene licencias para la subsidiaria de la transacción
        ...
        //#endregion Obtiene licencias para la subsidiaria de la transacción

        //#region Para MX, añade el campo de línea rules y le asigna valores en el desplegable
        ...
        //#endregion Para MX, añade el campo de línea rules y le asigna valores en el desplegable

        //#region Para BR crea campos personalizados
        if (scriptContext.type == 'create' || scriptContext.type == 'copy' || scriptContext.type == 'edit' || scriptContext.type == 'view') {
          if (LMRY_Result[0] === "BR" && Library_Mail.getAuthorization(877, licenses)) {
            libraryFleteGlobales.createCustpage(scriptContext);
          }
        }
        //#endregion Para BR crea campos personalizados

        //#region Oculta campo por período cerrado y obtiene licencias por el ExecutionContext MAP_REDUCE
        /* Validacion 04/02/22 */
        ...
        //#endregion Oculta campo por período cerrado y obtiene licencias por el ExecutionContext MAP_REDUCE

        //#region Captura la moneda local, agrega campo basecurrency y ejecuta WS
        ...
        //#endregion Captura la moneda local, agrega campo basecurrency y ejecuta WS

        //#region Añade campo "Set Status"
        if (scriptContext.type != 'print' && scriptContext.type != 'email') {
        ...
        //#endregion Añade campo "Set Status"
    ...
    function beforeSubmit(scriptContext) {
      try {
        ...
        log.error('change', (RCD.getValue('custbody_lmry_scheduled_process')));
          ...
          if (LMRY_Result[2] == true && LMRY_Result[3] == true && RCD.getValue({
            ...
            if (ST_FEATURE == false || ST_FEATURE == "F") {
              if (swAutoPe) {
                ...
                /* Library_AutoPercepcionDesc.autopercAfterSubmit(scriptContext, LMRY_Result[0], scriptContext.type); */
              }
            }
    ...
    function afterSubmit(scriptContext) {
      try {
        ...
        log.error('change 2', (RCD.getValue('custbody_lmry_scheduled_process')));
