                    ...
                    */
                    ...
                    if (cantidad > 0) {
                        ...
                        for (var i = 0; i < orden_invoice.length; i++) {
                            ...
                            if (!countJson[orden_invoice[i]]) {
                                countJson[orden_invoice[i]] = false
                            }
                        }
                        ...
                        ip.setValue({
                            fieldId: 'custrecord_lmry_ip_json_count',
                            value: JSON.stringify(countJson)
                        });
                        ip.setValue({
                        ...
                        ip.setValue({
                            fieldId: 'custrecord_lmry_ip_user',
                            value: Number(runtime.getCurrentUser().id)
                        });
