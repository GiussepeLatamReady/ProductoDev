...
define(['N/config', 'N/email', 'N/log', 'N/url', 'N/record', 'N/search', 'N/runtime', 'N/file', 'N/https',
        ...
        '/SuiteScripts/LS - Descuentos en Ventas/LS_AutoPercepcionDesc_LBRY_V2.0'
    ],

    function(config, email, log, url, record, search, runtime, file, https, libraryEmail, libraryFeature, libraryHandler,
        libraryUS, libraryTaxResult, libraryTaxWHT, libraryPercepcionesAR, libraryTransferIvaMX, libraryLatamTaxEC, librarySeries, logLbry, lsPercepciones) {
        // 245636 : DESARROLLO
        // 243159 : QA
        ...
        var agipt = scriptObj.getParameter({
            name: 'custscript_lmry_ip_params_agip'
        });
        ...
        function getInputData() {
            try {
                ...
                var currentLog = search.lookupFields({
                    ...
                    id: stateId,
                    columns: ['custrecord_lmry_ip_transactions', 'custrecord_lmry_ip_subsidiary.country', 'custrecord_lmry_ip_subsidiary', 'custrecord_lmry_ip_country']
                });
        ...
        function reduce(context) {
            try {
                ...
                if (document_type != null && document_type != '') {
                    ...
                    if (libraryFeature.getAuthorization(1029, licensesSub) && country == 'ARG' && agipt=='T') {
                    ...
                    } else if (country == 'ARG' && featurePercepcionesAR == true && (seteoUS == true || agipt=='T')) {
                        /*libraryPercepcionesAR.autoperc_beforeSubmit({
                            newRecord: id_load
                        }, 'AR', 'edit');*/
                        libraryPercepcionesAR.processPerception({newRecord: {id: current_transaction, type: type_transaction}}, 'AR', 'edit', true, id_load);
                        //lsPercepciones.autopercAfterSubmit({newRecord: {id: current_transaction, type: type_transaction}}, 'AR', 'edit', true, id_load);

                        //lsPercepciones.autopercAfterSubmit({newRecord: {id: current_transaction, type: type_transaction}}, 'AR', 'edit');
        ...
        function allGetRps(idTransacciones, subsidiaria, pais) {
            ...
            if (pais == 'BRA') {
                ...
                if (parseInt(currentNumber) < parseInt(rangoFin)) {
                    ...
                    // Sao Paulo, Belo Horizonte, Valinhos, Brasilia, Santo Andre, Fortaleza , Itajai
                    var municipios = ['3550308', '3106200', '3556206', '5300108', '3547809', '2304400', '4208203'];
