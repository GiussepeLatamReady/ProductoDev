...
define(['N/search',
    ...
    function(search, format, config, record, file, log, runtime, libreria, xml, url,render, libreriaReport,Lib_certificate_massive) {
        ...
        function CreateOrUpdatesLogs (id_files) {
            ...
            var recordLog = recordObj.save();

            libreria.sendrptuser(namereport, 3, namefile);
            Lib_certificate_massive.continueExecutionFlow(parametros.id_Vendor,recordLog,false,namefile + "." + extension,urlfile);
            return true;
        }
