  ...
  function (config, currencyModule, record, runtime, search, serverWidget, log,
    ...
    function beforeLoad(scriptContext) {
      try {
        ...
        type_interface = runtime.executionContext;
        ...
        if (LMRY_countr[0] == "MX" && (runtime.executionContext == 'USERINTERFACE' && (scriptContext.type == "create" || scriptContext.type == "edit" || scriptContext.type == "copy" || scriptContext.type == "view"))) {
    ...
    function beforeSubmit(scriptContext) {
      ...
      try {
        ...
        if (scriptContext.type == "create") {
          if (RCD_OBJ.getValue('entity') != '' && RCD_OBJ.getValue('entity') != null) {
            Library_ExchangeRate.ws_exchange_rate_uret(RCD_OBJ, licenses);
          }
        }
        ...
        if((["USERINTERFACE", "USEREVENT", "MAPREDUCE","WEBSERVICES","RESTWEBSERVICES","RESTLET","CSVIMPORT","SUITELET"].indexOf(type_interface) != -1) && scriptContext.type == "create" && LMRY_countr[0]=='AR'){
          libTools.inheritTaxes(RCD_OBJ);
        }
    ...
    function afterSubmit(scriptContext) {
      ...
      try {
        ...
        ******************************************************/
        ...
        if ((scriptContext.type === "create" || scriptContext.type === "edit" || scriptContext.type === "copy") && LMRY_countr[0] === 'MX') {
