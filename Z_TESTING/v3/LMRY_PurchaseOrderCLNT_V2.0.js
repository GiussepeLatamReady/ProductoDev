 ...
 */
define([
  'N/log', 'N/search', 'N/url', 'N/runtime', 
  './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', 
  './Latam_Library/LMRY_libNumberInWordsLBRY_V2.0', 
  './Latam_Library/LMRY_WebService_LBRY_v2.0.js', 
  './Latam_Library/LMRY_Custom_ExchangeRate_LBRY_V2.0.js',
  './Latam_Library/LMRY_MX_Pedimentos_LBRY_2.0'
],

  function (
    log, search, url, runtime, 
    Library_Mail, 
    Library_Number, 
    LR_webService, 
    Library_ExchangeRate,
    MXPedimentos
  ) {
