...
define(['N/transaction', 'N/config', 'N/ui/serverWidget', 'N/record', 'N/runtime', 'N/search', 'N/format',
    ...
    './Latam_Library/LMRY_Custom_ExchangeRate_Field_LBRY_V2.0.js', './Latam_Library/LMRY_Custom_ExchangeRate_LBRY_V2.0', './Latam_Library/LMRY_UniversalSetting_Purchase_LBRY',
    ...
    function (transaction, config, serverWidget, record, runtime, search, format, library, library1, libraryDIOT, Library_HideView,
        ...
        Library_ExchangeRate, library_Uni_Setting,Library_RedirecPayment) {
        ...
        function beforeSubmit(context) {
            try {
                ...
                if (type == 'create' && (type_interface == 'USERINTERFACE' || type_interface == 'CSVIMPORT')) {
                        ...
                        if (recordObj.getValue('custpage_uni_set_status') == 'T') {
                            if (featureAfterSaving == true || featureAfterSaving == 'T') {
                                if (type_document == '' || type_document == null) {
                                    library_Uni_Setting.automaticSetfieldPurchaseDocument(recordObj, false);
                                }
                            }
                        }
                    } else if (type_interface == 'CSVIMPORT') {
