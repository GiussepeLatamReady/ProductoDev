...
define(['N/log', 'N/search', 'N/runtime', 'N/email', 'N/format', 'N/url', 'N/https', 'N/record', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_Val_TransactionLBRY_V2.0', './Latam_Library/LMRY_AlertTraductorSale_LBRY_V2.0', './Latam_Library/LMRY_WebService_LBRY_v2.0.js', './Latam_Library/LMRY_Custom_ExchangeRate_LBRY_V2.0.js','./Latam_Library/LMRY_BR_Redirect_Payments_LBRY_V2.0'],

  function (log, search, runtime, email, format, url, https, record, library, library_Val, library_translator, LR_webService, Library_ExchangeRate,Library_RedirecPayment) {
