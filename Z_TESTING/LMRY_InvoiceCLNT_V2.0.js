 ...
 function (Library_Val, Library_Mail, Library_Number, Library_WHT_Transaction, library_ExchRate, currency, record, log, currentRecord, search, runtime, https, url, translation, library_translator, LR_webService, ST_ConfigFields, LbryBRDuplicate, Library_Duplicate_Clnt, Library_libTools, Library_ExchangeRate,Library_RedirecPayment) {
        ...
        function INVClnt_PageInit(scriptContext) {
            ...
            try {
                ...
                console.log("LMRY_countr[0]", LMRY_countr[0])
                console.log("LMRY_access", LMRY_access)
                //Tarifa variable C115
                if (LMRY_countr[0] == 'CO' && LMRY_access && (scriptContext.mode == 'create' || scriptContext.mode == 'copy' || scriptContext.mode == 'edit')) {
                    const FEATURE_WHT_NEW_LINES_PURCHASE = Library_Mail.getAuthorization(720, licenses);
                    const FEATURE_LOCALIZATION =  Library_Mail.getAuthorization(26, licenses);
        ...
        function INVClnt_SaveRecord(scriptContext) {
            try {
                ...
                if (LMRY_countr[0] != 'PE' && LMRY_access == true && !notInstances.includes(instancia[0])) {
