            ...
            try {
              ...
              var messageError = {
                "es": {
                  ...
                  "message": "El Journal fue creado, pero no se aplicó porque el periodo contable está completamente cerrado."
                },
                "en": {
                  "title": "Journal Not Applied",
                  "message": "The Journal was created but not applied because the accounting period is completely closed."
                },
                "pt": {
                  "title": "Diário Não Aplicado",
                  "message": "O Diário foi criado, mas não foi aplicado porque o período contábil está completamente encerrado."
                }
              }
              var myMsg = message.create({
                title: messageError[language]["title"],
                message: messageError[language]["message"],
                type: message.Type.CONFIRMATION
              });
              myMsg.show({
                duration: 10000
