...
define(['N/currentRecord', 'N/runtime', 'N/search', 'N/log', 'N/url', 'N/https', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0',
  ...
  './Latam_Library/LMRY_Log_LBRY_V2.0','./Latam_Library/LMRY_BR_Redirect_Payments_LBRY_V2.0'
],

  function (currentRecord, runtime, search, log, url, https, Library_Mail, Library_Val, Library_Entity_Validate, Library_Validate_RegNumber, record, libLog,Library_RedirecPayment) {
    ...
    function saveRecord(scriptContext) {
      try {
        ...
        /*Queda inhabilitado la funcionalidad debido a que existe cruce con lógica de Remito
        Fecha cambio: 09/02/2024 */
    ...
    function callModulePaymentForEntity(idSubsi, idEntity) {
      Library_RedirecPayment.callModulePaymentForEntity(idSubsi, idEntity);
    }
