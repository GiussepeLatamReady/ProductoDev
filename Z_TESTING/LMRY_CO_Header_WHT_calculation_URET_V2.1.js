        ...
        buildTable() {
            if (this.isUserInterface()) {
                ...
                const fields = [
                    ...
                    { id: 'custpage_col_total_amt', label: this.translations.LMRY_AMOUNT, type: serverWidget.FieldType.TEXT },
                    { id: 'custpage_col_state', label: this.translations.LMRY_STATE, type: serverWidget.FieldType.CURRENCY, displayType: serverWidget.FieldDisplayType.DISABLED },
        ...
        getTransactions() {
            ...
            search.create({
                ...
                transactions[internalid] = {
                    internalid,
                    legalDocument: result.getText(columns[4]),
                    entity: result.getText(columns[2]),
                    tranid: result.getValue(columns[5]),
                    type: result.getText(columns[1]),
                    recordType: result.getText(columns[3]),
                    amount: result.getText(columns[6]),
                    currency: result.getText(columns[7]),
