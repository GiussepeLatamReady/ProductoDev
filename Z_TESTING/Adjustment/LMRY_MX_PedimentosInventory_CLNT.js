...
||                                                              ||
||  File Name: LMRY_MX_PedimentosInventory_CLNT.js              ||
||                                                              ||
...
define(['N/log', 'N/record', 'N/runtime', 'N/currentRecord', 'N/url', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0'],
    ...
    function (log, record, runtime, currentRecord, url, library) {
        ...
        var LMRY_script = "LatamReady - MX Pediment Inventory CLNT";
        ...
        function setPedimentoLine(recordObj) {
            ...
            pedimento.addEventListener("keyup", function (e) {
                ...
                for (var i = 0; i < ItemCount; i++) {
                    ...
                    recordObj.setCurrentSublistValue({ sublistId: 'custpage_id_sublista', fieldId: 'id_pediment', value: e.target.value  });
                }
            })
        }
        ...
        function funcionCancel() {
            try {
                ...
                var urlTransaction = url.resolveRecord({ recordType: "inventoryadjustment", recordId: recordObj });
