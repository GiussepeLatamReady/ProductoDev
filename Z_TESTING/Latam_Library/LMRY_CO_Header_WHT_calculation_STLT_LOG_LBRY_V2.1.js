 ...
 * @NApiVersion 2.1
 * @NModuleScope Public
 * @Name LMRY_CO_Header_WHT_calculation_STLT_LOG_LBRY_V2.1.js
...
define(["N/log", "N/search", "N/runtime", "N/redirect", "N/ui/serverWidget", "N/url"],
    function (log, search, runtime, redirect, serverWidget, url) {
        ...
        const LMRY_script = 'LatamReady - CO Header WHT calculation STLT LBRY';
        ...
        class LibraryHandler {
            ...
            loadSublist() {
                ...
                data.forEach((form, i) => {
                    ...
                    sublist.setSublistValue({ id: "wht_type", line: i, value: whtType });
                    sublist.setSublistValue({ id: "process", line: i, value: process });
