...
define(['N/log', 'N/record', 'N/runtime', 'N/search', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_Log_LBRY_V2.0'],
    ...
    function (log, record, runtime, search, Library_Mail, Library_Log) {
        ...
        function pageInit(scriptContext) {
            try {
                ...
                if (['create', 'edit', 'copy'].includes(actionType)) {
                    ...
                    complementoPagoId = getComplementoPagoTransactionId();
                    if (complementoPagoId) {
                        transactionById[complementoPagoId] = "paymentComplement";
                    }
        ...
        const replicatedData = (recordObj) => {
            ...
            if (transactionID == 5 || transactionID == 7 || transactionID == 10 || transactionID == 16 || transactionID == 17 || transactionID == 20 || transactionID == 32 || transactionID == complementoPagoId) {
                filters.push(search.createFilter({
        ...
        const fillTransactions = (recordObj) => {
            ...
            const transactionsById = {
                ...
                "customtransaction_lmry_payment_complemnt": { name: "Complemento de Pago", id: complementoPagoId },
        ...
        const getComplementoPagoTransactionId = () => {
            ...
            if (CUSTOM_TRANSACTION_FEAT == "T" || CUSTOM_TRANSACTION_FEAT == true) {
                let complementoPagoRecord = record.create({
