  ...
  function (require, library_Uni_Setting, record, runtime, search, log, config, https, url, serverWidget, library, library1, libraryDIOT, Library_WHT_Transaction, ST_Library_Transaction,
    ...
    function afterSubmit(context) {
      try {
        ...
        var procesado = recordObj.getValue({
          fieldId: 'custbody_lmry_processed_transaction'
        });
        log.debug('procesado', procesado);
        licenses = library.getLicenses(subsidiary);
        ...
        log.debug('procesado 1', procesado);
        ...
        log.debug('procesado 2', procesado);
        ...
        if (type == 'create' || type == 'edit' || type == 'copy') {
          ...
          log.debug('procesado 3', procesado);
          ...
          log.debug('procesado 4', procesado);
        }
        ...
        log.debug('procesado 5', procesado);
        ...
        if (type == 'create' || type == 'edit') {
          ...
          log.debug('procesado 6', procesado);
          // Para Mexico
          if (LMRY_Result[0] == 'MX') {
        ...
        log.debug('procesado 7', procesado);
        /*********************** MODIFICACIÓN *****************************************************
        ...
        ******************************************************************************************/
        ...
        log.debug('procesado FIN', procesado);
      } catch (err) {
        recordObj = context.newRecord;
