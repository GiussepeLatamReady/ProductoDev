  ...
  function getSeries(arrayTrasactions, subsidiary, featuresPreImpreso) {
    ...
    while (flagSearch) {
      ...
      for (var i = 0; i < countLines; i++) {
        ...
        var _type = "";
        if (resultTest[0].getValue("type") == "Custom") {
          log.error('resultCustomers[i]',resultCustomers[i]);
