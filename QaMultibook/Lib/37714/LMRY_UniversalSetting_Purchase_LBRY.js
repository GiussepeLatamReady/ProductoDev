...
||  2.0     Feb 24 2022  LatamReady    Use Script 2.0           ||
 \= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = */
 define(['N/search', 'N/log', 'N/runtime', 'N/record', 'N/url', 'N/https', './LMRY_libSendingEmailsLBRY_V2.0', 'N/format', 'N/file', 'N/config', 'N/suiteAppInfo'],

 function(search, log, runtime, record, url, https, library_Mail, format, file, config, suiteAppInfo) {
     ...
     function set_preimpreso_purchase(currentRCD, LMRY_Result, licenses) {
                 ...
                 if ((LMRY_Result[0] == 'BR') && LMRY_Result[2]) {
                     ...
                     if (lmry_DocSer != '' && lmry_DocSer != null) {
                         ...
                         var wtax_type = search.lookupFields({
                             ...
                             id: lmry_DocSer,
                             columns: ['custrecord_lmry_serie_numero_impres', 'custrecord_lmry_serie_rango_fin', 'custrecord_lmry_serie_num_digitos', 'name']
                         });
                         ...
                         var lmry_DocSerText = wtax_type.name;
