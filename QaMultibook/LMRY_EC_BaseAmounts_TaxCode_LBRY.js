 ...
 * @NModuleScope Public
 */
define(['N/search', 'N/runtime', 'N/record', 'N/log', 'N/url', 'N/format', 'N/config'],

function(search, runtime, record, log, url, format, config) {
    ...
    function setBaseAmounts(objRecord, flowType){
      ...
      var jsonTaxCode = {};
      var jsonBaseAmounts = {1: {field: 'custbody_lmry_ec_base_rate0', amount: 0}, 2: {field: 'custbody_lmry_ec_base_rate12', amount: 0}, 3: {field: 'custbody_lmry_ec_base_rate14', amount: 0}};
      ...
      //log.debug('jsonBaseAmounts',jsonBaseAmounts);
