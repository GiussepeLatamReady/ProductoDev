 ...
 function (Library_Mail, Library_Number, log, record, search, runtime, format, Library_Duplicate) {
     ...
     function Create_WHT_Latam(Transaction, ID, ORCD) {
         ...
         if (Transaction == 'invoice' || Transaction == 'vendorbill') {
             ...
             Create_WHT_1(ID, Obj_RCD, RETEICA);
             Create_WHT_1(ID, Obj_RCD, RETEIVA);
             Create_WHT_1(ID, Obj_RCD, RETEFTE);

             // Custom Field for Bolivia
             Create_WHT_1(ID, Obj_RCD, RETEIT);
             // Solo en Vendor
             if (Transaction == 'vendorbill') {
                 Create_WHT_1(ID, Obj_RCD, RETEIU);
             }

             // Custom Field for Paraguay
             Create_WHT_1(ID, Obj_RCD, RETEIR);
             Create_WHT_1(ID, Obj_RCD, RETEIV);

             // Custom Field for Ecuador
             Create_WHT_1(ID, Obj_RCD, ECREIR);
             Create_WHT_1(ID, Obj_RCD, ECREIV);
         }
         ...
         try {
             ...
             if (objResult.length > 0) {
                 ...
                 if (amount != '' && amount != null) {
                     ...
                     amount_base = Math.round(amount_base * 100) / 100;
                     ...
                     amountresult = Math.round(amountresult * 100) / 100;
      ...
      * --------------------------------------------------------------------------------------------------- */
     function Create_WHT_1(ID, Obj_RCD, WHTID) {
      ...
      * Crea Transacciones en LatamReady WHT
      * --------------------------------------------------------------------------------------------------- */
     function Create_WHT_2(ID, Obj_RCD, WHTID) {
         var newObj_RCD = 0;
         try {
             if (WHTID == '' || WHTID == null) {
                 return newObj_RCD;
