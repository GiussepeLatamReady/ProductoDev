 ...
 * File : LMRY_TransferenciaIVAbyTaxCode_LBRY.js
 */
var objContext = nlapiGetContext();

var LMRY_script = 'LatamReady - MX Traslado IVA Tax Code PLGN';
var featureMB = false;
...
function transferenciaIvabyCode(transactionRecord, standardLines, customLines, book, licenses) {
    ...
    try {
        ...
        if (featureSubs) {
            filtrosCT[1] = new nlobjSearchFilter("custrecord_lmry_mx_vat_subsidiary", null, "is", [subsidiary]);
        }

        var columnasCT = new Array();
        columnasCT[0] = new nlobjSearchColumn("custrecord_lmry_mx_vat_tax_code");
        if (['customerpayment', 'customerrefund', 'depositapplication'].indexOf(transactionType) > -1) {
            ...
            columnasCT[1] = new nlobjSearchColumn("custrecord_lmry_mx_vat_debitsales");
            columnasCT[2] = new nlobjSearchColumn("custrecord_lmry_mx_vat_creditsales");
            columnasCT[3] = new nlobjSearchColumn("custrecord_lmry_mx_vat_earningsales");
            columnasCT[4] = new nlobjSearchColumn("custrecord_lmry_mx_vat_deficitsales");
        } else {
            entity = transactionRecord.getFieldValue("entity");
            columnasCT[1] = new nlobjSearchColumn("custrecord_lmry_mx_vat_debitpurchase");
            columnasCT[2] = new nlobjSearchColumn("custrecord_lmry_mx_vat_creditpurchase");
            columnasCT[3] = new nlobjSearchColumn("custrecord_lmry_mx_vat_earningpurchase");
            columnasCT[4] = new nlobjSearchColumn("custrecord_lmry_mx_vat_deficitpurchase");
        }
        columnasCT[5] = new nlobjSearchColumn("custrecord_lmry_mx_vat_is_ieps");

        var searchCT = nlapiCreateSearch("customrecord_lmry_mx_vat_transfer_acc", filtrosCT, columnasCT);
        ...
        if (resultCT != null && resultCT.length > 0) {
            for (var i = 0; i < resultCT.length; i++) {
                var taxCT = resultCT[i].getValue('custrecord_lmry_mx_vat_tax_code');
                if (jsonCT[taxCT] == null || jsonCT[taxCT] == undefined) {
                    if (['customerpayment', 'customerrefund', 'depositapplication'].indexOf(transactionType) > -1) {
                        jsonCT[taxCT] = {
                            'debit': resultCT[i].getValue('custrecord_lmry_mx_vat_debitsales'),
                            'credit': resultCT[i].getValue('custrecord_lmry_mx_vat_creditsales'),
                            'earning': resultCT[i].getValue('custrecord_lmry_mx_vat_earningsales'),
                            'deficit': resultCT[i].getValue('custrecord_lmry_mx_vat_deficitsales'),
                            'name': resultCT[i].getText('custrecord_lmry_mx_vat_tax_code'),
                            'ieps': resultCT[i].getValue('custrecord_lmry_mx_vat_is_ieps')
                        };
                        contadorCT++;
                    } else {
                        jsonCT[taxCT] = {
                            'debit': resultCT[i].getValue('custrecord_lmry_mx_vat_debitpurchase'),
                            'credit': resultCT[i].getValue('custrecord_lmry_mx_vat_creditpurchase'),
                            'earning': resultCT[i].getValue('custrecord_lmry_mx_vat_earningpurchase'),
                            'deficit': resultCT[i].getValue('custrecord_lmry_mx_vat_deficitpurchase'),
                            'name': resultCT[i].getText('custrecord_lmry_mx_vat_tax_code'),
                            'ieps': resultCT[i].getValue('custrecord_lmry_mx_vat_is_ieps')
                        };
                        contadorCT++;
            ...
            columnasMXIVA[1] = new nlobjSearchColumn("custrecord_lmry_mx_vat_transfer_by_code");
            ...
            if (ResultMXIVA != null && ResultMXIVA.length > 0) {
                ...
                for (var i = 0; i < ResultMXIVA.length; i++) {
                    ...
                    if (jsonMXIVA[idBillMX] == null || jsonMXIVA[idBillMX] == undefined) {
                        var dataByCode = ResultMXIVA[i].getValue('custrecord_lmry_mx_vat_transfer_by_code');
                        jsonMXIVA[idBillMX] = {
            ...
            columnasMXDev[1] = new nlobjSearchColumn("custrecord_lmry_mx_vat_transfer_by_code");
            ...
            if (SearchMXDev && SearchMXDev.length) {
                ...
                for (var i = 0; i < SearchMXDev.length; i++) {
                    ...
                    var dataByCode = SearchMXDev[i].getValue('custrecord_lmry_mx_vat_transfer_by_code');
                    dataByCode = dataByCode ? JSON.parse(dataByCode) : {};
