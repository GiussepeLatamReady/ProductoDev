...
define(['N/record', 'N/ui/serverWidget', 'N/search', 'N/runtime', 'N/log', 'N/config', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_libWhtValidationLBRY_V2.0',
    ...
    './WTH_Library/LMRY_BO_Taxes_LBRY_V2.0', './WTH_Library/LMRY_MX_STE_BillCredit_WHT_Total_LBRY_V2.0', './Latam_Library/LMRY_PE_STE_Purchases_Tax_Transaction_LBRY_V2.0'
],
    ...
    function (record, serverWidget, search, runtime, log, config, library, library1, libraryDIOT,
        ...
        MX_STE_WhtLibrary_Total, PE_STE_TaxLibrary) {
        ...
        function beforeLoad(context) {
            try {
                ...
                var createFrom = recordObj.getValue({ fieldId: "createdfrom" });
