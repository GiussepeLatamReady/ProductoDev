...
define(['N/log', 'N/config', 'N/ui/serverWidget', 'N/record', 'N/search', 'N/runtime', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_HideViewLBRY_V2.0', './Latam_Library/LMRY_GLImpact_LBRY_V2.0',
  ...
  function(log, config, serverWidget, record, search, runtime, library, library_HideView, libraryGLImpact, lbry_traslado_IVA, lbry_br_custpaymt, library_Uni_Setting, LibraryValidatePeriod, ivaReverse, Library_ExchangeRate_Field) {
          ...
          if (library_Uni_Setting.auto_universal_setting(licenses, false)) {
            ...
            if (type_interface == 'USERINTERFACE') {
              ...
              if ((check_csv == false || check_csv == 'F') && (type_document == '' || type_document == null)) {
                ...
                if (check_csv == 'F') {
                  newRecord.setValue('custbody_lmry_scheduled_process', 'T');
                } else {
                  newRecord.setValue('custbody_lmry_scheduled_process', true);
                }
              }
            }
          }
        ...
        if (type_event == 'create' && (type_interface == 'USERINTERFACE' || type_interface == 'CSVIMPORT')) {
          ...
          if (type_interface == 'USERINTERFACE') {
            ...
            if (check_csv == 'T' || check_csv == true) {
              ...
              if (check_csv == 'T') {
                newRecord.setValue('custbody_lmry_scheduled_process', 'F');
              } else {
