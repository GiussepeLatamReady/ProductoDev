    ...
    function (search, log, runtime, record, url, https, library_Mail, format, file, config, suiteAppInfo, logLbry) {
        ...
        function auto_universal_setting(licenses, type_event) {
            ...
            try {
                ...
                /*Feature EI-Setup (General Functions)
                  ...
                  'CR': 225,'EC': 226,'MX': 227,'PA': 440,'PE': 228,'UY': 229, 'GT': 638, 'PY': 963
                };*/

                //Feature EI-Setup (General Functions)
                var arrayFeat1 = [220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 440, 638, 963];
                ...
                if (!type_event) {
                    if (type_interface == 'CSVIMPORT') {
                        ...
                        */
                        arrayFeat2 = [433, 592, 431, 434, 435, 593, 594, 436, 442, 437, 595, 705, 957];
                        ...
                        */
                        arrayFeat2 = [323, 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336];
                    }
                }
                    ...
                    if (data != null && data != '') {
                     ...
                     if ( id_country == '157' && (type_transaction == "invoice"  || 
                        ...
                        if (serie_id && !docum_sg){
                            ...
                            var diseno_id = search.lookupFields({ type: 'customrecord_lmry_serie_impresion_cxc', 
                                            id: serie_id, columns: ['custrecord_lmry_diseno_pdf'] }).custrecord_lmry_diseno_pdf;
                            
                            diseno_id = diseno_id[0].value;
                            log.error('custbody_lmry_mx_document_design', diseno_id);

                            // Latam - MX Document Design
                            diseno_id ? currentRCD.setValue('custbody_lmry_mx_document_design',diseno_id)
                                       : currentRCD.setValue('custbody_lmry_mx_document_design', '');
                        } 
                    } // 2022.01.13 :Solo para Mexico
            ...
            try {
                ...
                switch (type_transaction) {
                    ...
                    case 'customtransaction_lmry_payment_complemnt':
                        filters.push('AND', ['custrecord_lmry_us_transaction', 'anyof', 39]);
                        if (check_fact == 1) {
                            filters.push('AND', ['custrecord_lmry_document_type.custrecord_lmry_fact_electronica', 'is', 'F']);
                        } else if (check_fact == 2) {
                            filters.push('AND', ['custrecord_lmry_document_type.custrecord_lmry_fact_electronica', 'is', 'T']);
        ...
        function setear_datos_invoice(recordCreditMemo) {
            try {
                ...
                /*
                   ...
                   */
                //23-02-2022
                if (type_transaction != 'creditmemo' || (id_country != 157 && id_country != 29 && id_country != 48 && id_country != 91 && id_country != 173 && id_country != 174 && id_country != 49 && id_country != 45 && id_country != 63 && id_country != 11 && id_country != 30 && id_country != 186)) {
                    return false;
                }
                ...
                if (idTrans != '' && idTrans != null) {
                    ...
                    if (invoiceID != '') {
                        ...
                        if (id_country != 157 && id_country != 29 && id_country != 48 && id_country != 91 && id_country != 173 && id_country != 174 && id_country != 49 && id_country != 45 && id_country != 63 && id_country != 11) {
                            return false;
                        }
                        ...
                        if (id_country == 29)
                            recordCreditMemo.setValue('custbody_lmry_amt_doc_ref', document_amt_ref);
                    }
                }

            } catch (err) {
                logLbry.doLog({ tittle: '[ setear_datos_invoice ]', message: err, relatedScript: LMRY_script });
        ...
        function set_inv_identifier(RCD) {
            ...
            try {
                ...
                //Solo para MX,CO, CR, CL, AR, UY, PE, BR, PA, EC, BO y GT
                if (country_m == 157 || country_m == 48 || country_m == 49 || country_m == 45 || country_m == 231 || country_m == 11 || country_m == 174 || country_m == 30 || country_m == 173 || country_m == 63 || country_m == 29 || country_m == 91) {
                    ...
                    if (country_m != '' && country_m != null) {
                        ...
                        if (resgetmatchline != '' && resgetmatchline != null) {
                            ...
                            if (country_m == 157) {
                                ...
                                if (country_m == 63) {
                                    subsiOW = runtime.isFeatureInEffect({ feature: "SUBSIDIARIES" });
                                    var baseFilters = [];
                                    baseFilters[0] = search.createFilter({ name: 'isinactive', operator: 'is', values: 'F' });
                                    baseFilters[1] = search.createFilter({ name: 'custrecord_lmry_ec_taxcode_apply_to', operator: 'anyof', values: '2' });
                                    if (subsiOW) {
                                        baseFilters[2] = search.createFilter({ name: 'custrecord_lmry_ec_taxcode_subsidiary', operator: 'is', values: id_subsidiary });
                                    }
                ...
                logLbry.doLog({ tittle: '[ set_inv_identifier ]', message: err, relatedScript: LMRY_script });
        ...
        function search_entity(licenses) {
            ...
            try {
                ...
                */
                ...
                //Feature EI-Setup (General Functions)
                var arrayFeat2 = [220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 440, 638, 963];
        ...
        function set_preimpreso(currentRCD, LMRY_Result, licenses) {
            ...
            try {
                ...
                if (lmry_DocNum == '' || lmry_DocNum == null) {
                    ...
                    if ((LMRY_Result[0] == 'MX' || LMRY_Result[0] == 'BR' || LMRY_Result[0] == 'CO' || LMRY_Result[0] == 'UY' || LMRY_Result[0] == 'BO' || LMRY_Result[0] == 'GT' || LMRY_Result[0] == 'PA' || LMRY_Result[0] == 'PE' || LMRY_Result[0] == 'PY') && LMRY_Result[2]) {
        ...
        function tax_calculator(currentRCD) {
            ...
            try {
                ...
                logLbry.doLog({ tittle: '[ tax_calculator ]', message: err, relatedScript: LMRY_script });
        ...
        function setear_documento_hibrido(currentRCD, id_record, id_record_key) {
            ...
            if (country_id == 30) {
                var new_filters = [["isinactive", "is", "F"]];
                ...
                var customrecord_lmry_universal_setting_v2SearchObj = search.create({
                    ...
                    columns:
                        [
                            search.createColumn({ name: "custrecord_lmry_document_type", label: "Latam - Legal Document Type (Set)" }),
                            search.createColumn({ name: "custrecord_lmry_serie_doc_cxc", label: "Latam - Serie CxC (Set)" }),
                            search.createColumn({
                                name: "formulanumeric",
                                formula: "{custrecord_lmry_serie_doc_cxc.custrecord_lmry_serie_numero_impres}",
                                label: "Formula (Numeric)"
                            }),
                            search.createColumn({ name: "custrecord_set_br_comercial_document", label: "Latam - BR Comercial Document Number (Set)" }),
                            search.createColumn({ name: "custrecord_set_br_tlf_terminal", label: "Latam - BR Telephone Terminal Number (Set)" })
                        ]
                });
                data_result = customrecord_lmry_universal_setting_v2SearchObj.run().getRange(0, 1);
                if (data_result) {
                    var new_doc_type_id = data_result[0].getValue({ name: 'custrecord_lmry_document_type' });
                    var new_id_serie_doc = data_result[0].getValue({ name: 'custrecord_lmry_serie_doc_cxc' });
                    var new_serie_preimpreso = parseInt(data_result[0].getValue({
                        name: "formulanumeric",
                        formula: "{custrecord_lmry_serie_doc_cxc.custrecord_lmry_serie_numero_impres}"
                    })) + 1;
                    var new_comercial_document = data_result[0].getValue({ name: 'custrecord_set_br_comercial_document' });
                    var new_tlf_terminal = data_result[0].getValue({ name: 'custrecord_set_br_tlf_terminal' });
        ...
        */
        ...
        function validateDocument(currentRCD, set_data, validateFieldsAR) {
            try {
                ...
                var setupTaxSrch = search.create({
                    ...
                    columns:
                        [
                            ...
                            "custrecord_lmry_setuptax_ar_doc_type_val",
                            "custrecord_lmry_setuptax_ar_min_amount"
                        ]
                });
                ...
                if (currentRCD.getValue('custbody_lmry_document_type') == setupTaxDocument && total < setupTaxMinAmount) for (var j = 0; j < set_data.length; j++) {
                ...
                logLbry.doLog({ tittle: '[ validateDocument ]', message: error, relatedScript: LMRY_script });
        ...
        function getExchangeRate(recordObj, currencySetup) {
            try {
                var exchangerate = 1;
                var featureSUB = runtime.isFeatureInEffect({ feature: "SUBSIDIARIES" });
                ...
                logLbry.doLog({ tittle: '[ getExchangeRate ]', message: error, relatedScript: LMRY_script });
