 ...
 *@NModuleScope Public
 */
define(['N/runtime', 'N/search', 'N/record', 'N/url', 'N/https', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_BR_ValidateDuplicate_LBRY_V2.0','./Latam_Library/LMRY_AR_Unit_Price_LBRY_V2.0'],
    function (runtime, search, record, url, https, libraryMail, LbryBRDuplicate, libraryUnitPrice) {
        ...
        function validateField(scriptContext) {
            try {
                ...
                if (scriptContext.sublistId == 'item' && scriptContext.fieldId == 'item') {
                    if (LMRY_countr[0] == 'AR') {
                        libraryUnitPrice.disabledFieldLine(scriptContext.line);
                    }
                }
        ...
        function ValidateAccessTO(ID) {
            ...
            try {
                ...
                if (LMRY_access == true) {
                    libraryMail.onFieldsDisplayBody(recordObj, LMRY_countr[1], 'custrecord_lmry_on_transfer_order', false);
                }
