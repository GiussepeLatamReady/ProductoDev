 ...
 *@NModuleScope Public
 */
define(['N/log', 'N/search', 'N/query', 'N/url', 'N/https', 'N/runtime', 'N/record', 'N/format', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0', './Latam_Library/LMRY_BR_ValidateDuplicate_LBRY_V2.0', './Latam_Library/LMRY_libToolsFunctionsLBRY_V2.0', './Latam_Library/LMRY_MX_Pedimentos_LBRY_2.0'],
    function (log, search, query, url, https, runtime, record, format, library_mail, LbryBRDuplicate, libTools, MXPedimentos) {
        ...
        function correlativoChile(option) {
            ...
            if (document_type && LMRY_countr[0] == 'CL' && !isSeriesCLActive && library_mail.getAuthorization(112, licenses) == true) {
                ...
                if (featureSubs == true || featureSubs == 'T') {
                    filters.push('AND', ['custrecord_lmry_cl_np_subsidiary.country', 'anyof', 'CL']);
                }
