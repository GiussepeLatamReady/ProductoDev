...
define(['N/currentRecord', 'N/runtime', 'N/search', 'N/log', 'N/url', 'N/https', './Latam_Library/LMRY_libSendingEmailsLBRY_V2.0',
  ...
  function (currentRecord, runtime, search, log, url, https, Library_Mail, Library_Val, Library_Entity_Validate, Library_Validate_RegNumber, record, libLog) {
    ...
    function callModuleCustomerPayment(idSubsi, idEntity) {
        try {
          console.log("idSubsi", idSubsi)
          console.log("idEntity", idEntity)
            var params = { idS: idSubsi, idE: idEntity };
    ...
    return {
      ...
      callModuleCustomerPayment: callModuleCustomerPayment
    };
