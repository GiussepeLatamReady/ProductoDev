...
define(['N/ui/serverWidget', 'N/search', 'N/redirect', "N/email", "N/encode", 'N/runtime', 'N/record', 'N/render', 'N/file', "N/config", "N/url", "N/http", "N/https", "N/transaction", '/SuiteBundles/Bundle 245636/EI_Library/LMRY_AnulacionInvoice_LBRY_V2.0'],
    function(serverWidget, search, redirect, email, encode, runtime, record, render, file, config, url, http, https, transaction, library_AnulacionInvoice) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method == 'GET') {
                ...
                try {
                    ...
                    if(nSerieDoc && nTypeDoc){
                        getOtherFields(nTypeRec, nSerieDoc, nTypeDoc);
                    } else{
                        getOtherFields(nTypeRec, '', '');
                    }
        ...
        function checkStatus(xml) {
            ...
            if (estatus != null && estatus != '') { //SI TIENE DATA
                ...
                if (estatus == "201") {
                    ...
                    var estatusUUID = xml.split('resultados>')[1].split('estatusUUID>')[1].split('</')[0];
                    ...
                    if (["204", "213", "500", "501", "502", "503", "601",
            ...
            if (subsi) {
                ...
                var busqEnabFet = search.create({
                    ...
                    columns: ['custrecord_lmry_mx_fel_host', 'custrecord_lmry_mx_fel_sendtype',
                        'custrecord_lmry_mx_fel_user', 'custrecord_lmry_mx_fel_password'
                    ],
                    filters: [
        ...
        function getOtherFields(_nTypeRec,_nSerieDoc,_nTypeDoc) {
            ...
            if(_nSerieDoc != '' && _nTypeDoc != ''){
                ...
                var Rec = search.lookupFields({
                    type: typeRecord,
                    id: nInternalid,
                    columns: ['subsidiary', 'custbody_lmry_num_preimpreso']
                });
                ...
                var Rec = search.lookupFields({
                    type: typeRecord,
                    id: nInternalid,
                    columns: ['subsidiary', 'custbody_lmry_num_preimpreso', 'custbody_lmry_serie_doc_cxc', 'custbody_lmry_document_type']
                });
                subsidiary = Rec.subsidiary[0].value;
                folio = Rec.custbody_lmry_num_preimpreso;
