    ...
    function (search, runtime, serverWidget, log, Library_Mail, Library_HideView, library_Uni_Setting, Library_RedirecPayment) {
        ...
        function beforeLoad(scriptContext) {
            try {
                ...
                if (isURET == 'view' && LMRY_countr[0] == 'BR' && runtime.executionContext == 'USERINTERFACE' && LMRY_access == true) {
            ...
            try {
                ...
                if (LMRY_access == true) {
                    if (isURET == 'view' && hide_entities) {
                        Library_HideView.HideEntityFields(FORM, LMRY_countr[1], RCD.type, licenses);
