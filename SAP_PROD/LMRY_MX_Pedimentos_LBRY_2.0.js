    ...
    function isValidItemsTransaction(recordObj) {
        ...
        items.forEach(function (itemLine) {
            ...
            if (quantitytotal > sumQuantityDisp) {
                message = 'No se creará registro de pedimento porque no hay stock suficiente, Desea continuar';
            } else {
                for (var i = 0; i < listPediment.length; i++) {
                ...
                if (quantitytotal > 0) message = ' No se creará registro de pedimento porque no hay stock suficiente, Desea continuar';
            };
        });
        return message;
    }
