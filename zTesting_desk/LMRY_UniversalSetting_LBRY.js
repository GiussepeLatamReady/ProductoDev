            ...
            try {
                ...
                if (data_automatic_search != '' && data_automatic_search != null) {
                    ...
                    if (data != null && data != '') {
                        ...
                        log.debug(LMRY_script, ' [ automatic_set_field ] - Configuración incorrecta ');
                    }
                }
            ...
            try {
                ...
                if (data_automatic_search != '' && data_automatic_search != null) {
                    ...
                    if (data_record != null && data_record != '') {
                        ...
                        log.debug(LMRY_script, ' [automatic_setfieldrecord] - Configuración incorrecta: ' + id_record);
                    }
                    ...
                    if (doc_type != '' && doc_type != null) {
                        ...
                        if (resultTempDoc != null && resultTempDoc.length != 0) {
                            ...
                            if (package_customer_id == package_id) {
                                ...
                                log.debug(LMRY_script, ' - [set_template] Configuración erronea');
                            }
                        }
                    }
                }
