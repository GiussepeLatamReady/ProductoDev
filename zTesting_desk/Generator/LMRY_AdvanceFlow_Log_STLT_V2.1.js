...
define(['N/log',
    ...
    (nLog,nServerWidget,nUrl,AF_Library,TRE_Library, SendEmail_LBRY) => {
        /**
                    ...
                    if (!paramIsDetails || paramIsDetails === "F") {
                        ...
                        */
                        const inlineHtmlField = form.addField({
                            ...
                            label: translatedFieldsTRE.afFldInlineHtml,
                        ...
                        const resultList = form.addSublist({
                            ...
                            label: translatedFieldsTRE.afLstResult,
                        ...
                        resultList.addField({ id: "listcol_lmry_ste_process_date", type: nServerWidget.FieldType.DATE, label: translatedFieldsTRE.treLstColProcessDate });
                        ...
                        if (paramLogId && paramLogId !== "" && paramLogId !== null) {
                            const treLogSearch = nSearch.lookupFields({
                                ...
                                id: paramLogId,
                                columns: [ "custrecord_lmry_ste_af_log_trans_ids" ,"custrecord_lmry_ste_af_log_datefrom","custrecord_lmry_ste_af_log_dateto"]
                            });
                            ...
                            detailsList.addField({ id: "listcol_lmry_ste_trans_id", type: nServerWidget.FieldType.TEXT, label: translatedFieldsTRE.treLstColSubsidiary });
