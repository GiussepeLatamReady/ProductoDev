  ...
  function(
    ...
    function onRequest(context) {
      ...
      if (context.request.method == 'GET') {
        ...
        let searchResult = operations.getSearchAccount();
        ...
        subsidiaryTable.addColumn('custpage_col_sales_det_acc', 'select')
          .setOptions(searchResult.detraction).isMandatory(true);

        subsidiaryTable.addColumn('custpage_col_sales_bank_acc', 'select')
          .setOptions(searchResult.bank).isMandatory(true);
