...
||                                                              ||
||  File Name: LMRY_MX_Reverse_Cancellation_Log_LBRY_V2.1.js     ||
||                                                              ||
    ...
    function (log,search, runtime, redirect, serverWidget,url) {
        ...
        class LibraryHandler {
            ...
            createLogForm() {
                ...
                if (this.params.isDetails == 'T') {
                    this.form = serverWidget.createForm({
                        title: 'LatamReady - MX Canceled Documents Reversed Details'
                    });
                    return this.form;
                }else{
                    this.form = serverWidget.createForm({
                        title: 'LatamReady - MX Canceled Documents Reversed Log'
                    });
                }
            ...
            createSublistDetails(){
                ...
                sublist.addField({
                    id: "id_void",
                    label: "Transacción de anulación",
                    type: serverWidget.FieldType.TEXT
                });
            ...
            loadSublistDetails(){
                ...
                ids.forEach((id,i)=>{
                    ...
                    if (transVoid) {
                        log.error("seteo campo void",transVoid)
                    ...
                    if (transReverse) {
                        log.error("seteo campo reverse",transVoid)
