 ...
 */
// @ts-check
define(['N/record', 'N/currency', 'N/task', 'N/log', 'N/xml', 'N/ui/serverWidget', 'N/search', 'N/runtime', 'N/redirect', 'N/email', 'N/config',
     ...
     * @returns 
     */
    function (record, currency, task, log, xml, serverWidget, search, runtime, redirect, _email, _config, library) {
        // Nombre del Script
                ...
                if (context.request.method == 'GET') {
                    ...
                    if (isOneWorld == true) {
                        ...
                        var search_pay = search.load({
                            id: 'customsearch_lmry_pe_account_payable'
                        });
                        ...
                        var lengt_pay = resul_pay.getRange({
                            start: 0,
                            end: 1000
                        });
                        ...
                        if (lengt_pay != null && lengt_pay.length > 0) {
                            ...
                            fieldAccoundPay.addSelectOption({
                                value: 0,
                                text: ' '
                            });
                    ...
                    if (isOneWorld == true) {
                        ...
                        var search_bank = search.load({
                            id: 'customsearch_lmry_pe_bank_account'
                        });
                        ...
                        var lengt_bank = resul_bank.getRange({
                            start: 0,
                            end: 1000
                        });

                        if (lengt_bank != null && lengt_bank.length > 0) {
                            fieldBank.addSelectOption({
                                value: 0,
                                text: ' '
                            });
                    ...
                    if (isOneWorld == true) {
                        ...
                        if (requestSubsidiaryID != '' && requestSubsidiaryID != null) {
                            ...
                            field_acc_payable.addSelectOption({
                                value: 0,
                                text: ' '
                            });
                            ...
                            var search_period = search.load({
                                id: 'customsearch_lmry_pe_accounting_period'
                            });
