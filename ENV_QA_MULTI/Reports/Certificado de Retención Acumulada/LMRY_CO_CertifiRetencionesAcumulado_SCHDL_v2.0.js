...
define(["N/record", "N/runtime", "N/file", "N/search", "N/format", "N/log", "N/config",
   ...
   function(record, runtime, file, search, format, log,
       config, libreria, render, url, xml, libreriaReport) {
       ...
       function getNameFile(retention,id_extension) {
           ...
           if(id_extension == 'pdf'){
               name = strNameFile + '_' + retType + '_' + companyruc + companydv + '_' + anio + '_' + paramsubsidi + '_'+ name_muni 
           }else if(id_extension == 'zip'){
               name = strNameFile + '_' + companyruc + companydv + '_' + anio + '_' + paramsubsidi 
           }
