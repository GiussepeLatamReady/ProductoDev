...
define([
    ...
    (log, search, redirect, runtime, serverWidget, url, task, LibraryMail) => {
        const CLIENT_SCRIPT_PATH = "./SMC_CO_Header_WHT_calculation_CLNT_V2.1.js";
        ...
        class SuiteletFormManager {
            ...
            getNames(deploy) {
                let nameList = {
                    customdeploy_smc_co_head_wht_calc_stlt: {
                        ...
                        deployid: 'customdeploy_smc_co_head_calc_stlt_log',
                        scriptMapReduce: 'customscript_smc_co_head_wht_calc_mprd',
                        deployMapReduce: 'customdeploy_smc_co_head_wht_calc_mprd',
                        paramuser: 'custscript_smc_co_head_wht_calc_user',
                        paramstate: 'custscript_smc_co_head_wht_calc_state'
                    }
                };
            ...
            createForm() {
                ...
                this.form = serverWidget.createForm({
                    title: 'SMC - CO Header WHT calculation'
                });
            ...
            loadTransactionSublist() {
                ...
                data.forEach((transaction, i) => {
                    ...
                    log.debug('loadTransactionSublist : transaction', transaction);
                    // Arreglo con objeto
            ...
            runMapReduce({ state, user }) {
                ...
                const parameters = featureLatam ? {
                    custscript_smc_co_head_wht_calc_user: user,
                    custscript_smc_co_head_wht_calc_state: state
                } : {};
