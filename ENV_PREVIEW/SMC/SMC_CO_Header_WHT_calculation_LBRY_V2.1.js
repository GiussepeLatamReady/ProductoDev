...
define([
    ...
    const getWhtCode = (nameWht) => {
        ...
        if (nameWht != "Retention name not found") {
            ...
            searchColumns.push(search.createColumn({ name: 'formulatext', formula: '{custrecord_lmry_wht_types.custrecord_smc_wht_subtype}' }));
            searchColumns.push(search.createColumn({ name: 'formulatext', formula: '{custrecord_lmry_wht_types.custrecord_smc_wht_subtype.id}' }));
