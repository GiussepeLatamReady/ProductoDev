...
define(['N/runtime', 'N/ui/serverWidget', 'N/search', 'N/url'], (runtime, serverWidget, search, url) => {
    ...
    class UIManager {
        ...
        buildTable() {
            ...
            this.form.clientScriptModulePath = './SMC_CO_Header_WHT_calculation_CLNT_V2.1.js';
            this.form.addButton({
        ...
        getTransactions() {
            const transactionsState = JSON.parse(
                this.scriptContext.newRecord.getValue('custrecord_smc_co_hwht_log_transactions'));

            const recordLogState = this.scriptContext.newRecord.getValue('custrecord_smc_co_hwht_log_state');
