        ...
        function onRequest(context) {
            ...
            try {
                ...
                if (context.request.method == 'GET') {
                    ...
                    var p_line = FORM.addField({ id: 'custpage_id_line', label: 'Line', type: serverWidget.FieldType.TEXT, container: 'group_pi' }).updateDisplayType({ displayType: serverWidget.FieldDisplayType.HIDDEN });
                    ...
                    var pedimentohidden = SubTabla.addField({ id: 'custpage_pedimento_hidden', label: 'PEDIMENTO', type: serverWidget.FieldType.TEXT }).updateDisplayType({ displayType: serverWidget.FieldDisplayType.ENTRY });
                    pedimentohidden.updateDisplayType({ displayType: serverWidget.FieldDisplayType.HIDDEN });
                    ...
                    if (result_pedimento_details != null && result_pedimento_details.length > 0) {
                        ...
                        for (var j = 0; j < result_pedimento_details.length; j++) {
                            ...
                            if (cantidadPed > 0) {
                                ...
                                SubTabla.setSublistValue({ id: 'custpage_pedimento_hidden', line: k, value: numPed });
